...
zabbix_sender = '/wls/serviceop/trust_zabbix/bin/zabbix_sender'
zabbix_conf = '/wls/serviceop/trust_zabbix/etc/zabbix_agentd.conf'
send_to_zabbix = 1
...
class ZooKeeperServer(object):
    ...
    def __init__(self, host='30.16.41.1', port='2181', timeout=1):
